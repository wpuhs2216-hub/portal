...
const purgeCloudflareCache = require('./purge-cache');
...
async function deploy() {
  try {
    ...
    try {
      ...
      console.log(`Site should be available at: http://${config.host}`);
      console.log('========================================\n');
    ...
    try {
      ...
      console.warn('⚠️  キャッシュパージに失敗しましたが、デプロイは完了しています。');
      console.warn('手動でCloudflareダッシュボードからキャッシュをパージしてください。');
    }
